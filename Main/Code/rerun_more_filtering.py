...
This code was used in response to the revisions and regenerates the main results using different level of filtering paramters i.e. more stringent filtering
"""
