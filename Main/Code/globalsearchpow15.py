...
#traits = ['study_126_Trichome_stem_length']
all_traits =  sorted(ara_data.get_trait_names())
choosen_traits = list(pd.read_csv('/Research_Data_new/Trait-genetic-architecture-and-population-structure-genomic-prediction/Main/results/traits_used.csv')['name'])

traits = ['dummy'] + choosen_traits + [trait for trait in all_traits if trait not in choosen_traits]
